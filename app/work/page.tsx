...
const projects = [
  {
    ...
    description: "A full-featured online shopping platform with cart management, payment processing, and order tracking. Built for scalability and performance.",
  ...
  },
  {
    ...
    description: "An AI-powered tool that helps users generate blog posts, social media content, and marketing copy using advanced language models.",
  ...
  },
  {
    ...
    description: "A comprehensive real estate listing platform with map integration, virtual tours, and mortgage calculators.",
    technologies: ["Next.js", "Mapbox", "Prisma", "AWS S3", "Tailwind CSS"],
  },
  {
    title: "Social Media Dashboard",
    description: "An analytics dashboard for managing multiple social media accounts with scheduling and performance insights.",
